...
public class LoginTest {
	...
	By addCustomerMenuField = By.xpath("//a[contains(text(), 'Add Customer')]");
	...
	By countryDropdownField = By.xpath("//*[@id=\"country\"]");
	...
	public void addCustomer() throws InterruptedException {
		...
		selectFromDropdown(countryDropdownField, "United Kingdom");
